...
.. image:: https://img.shields.io/travis/timcera/cltoolbox
    :alt: Travis-CI badge
    :target: https://travis-ci.org/timcera/cltoolbox

.. image:: https://img.shields.io/coveralls/timcera/cltoolbox
    :alt: Coveralls badge
    :target: https://coveralls.io/r/timcera/cltoolbox

.. image:: https://img.shields.io/pypi/implementation/cltoolbox?label=%20&logo=python&logoColor=white
    :alt: PyPI - Implementation

.. image:: https://img.shields.io/pypi/v/cltoolbox
    :alt: Latest release
    :target: https://pypi.python.org/pypi/cltoolbox

.. image:: https://img.shields.io/pypi/l/cltoolbox
    :alt: PyPI - License
...
.. image:: https://img.shields.io/pypi/format/cltoolbox
    :alt: Download format
